...
ggplot(mpg, aes(x = manufacturer, y = cyl)) + geom_point() + annotation_custom(g, xmin=-Inf, xmax=Inf, ymin=-Inf, ymax=Inf)
```
...
Scraping Twitter for everyone's favourite progressive Swedish death metal band, Opeth! 🤘  
...
small_data %>% 
  fgplot(aes(x = Points, y = Game, group = Team, colour = Team)) +
  geom_point() +
  geom_line(size = 2) + 
  coord_flip() +
...
---
# Sample size and population r=.5
---
class: center, middle

---
# Hand off to Shiny Widget
