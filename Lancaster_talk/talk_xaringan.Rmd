...
subtitle: ""
author: "Andrew Stewart<br>University of Manchester<br><br>Twitter: @ajstewart_lang<br>GitHub: github.com/ajstewartlang"
...
knitr::include_graphics("deadly.jpg")
```
]
...
---
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("Gelman.jpg")
```
...
```{r, echo=FALSE}
knitr::include_graphics("tidyflow.png")
```
...
The data on the previous slide are clearly bimodal with nodata point near the mean.  Distribution shape matters and we need to capture that in our data visualisations.
...
---
# Raincloud Plots
You might have noticed the violin plots have a little redundant information - the shape of the distribution is plotted, but it's also mirrored (which we don't really need). https://peerj.com/preprints/27137v1/
<p>
...
# Add the layer bbc_style() at the end of your ggplot() code
...
knitr::include_graphics("wilke.png")
```
]
]
...
Both the Open Science Foundation (http://sf.io) and GitHub (http://gthub.com) can be used to host your data and 
...
You can use your R Markdown script to produce HTML, Pord , or PDFdocuments.  HTML documents allow you to embed
animated graphs.
...
knitr::include_graphics("frederik.png")
```
]
]
...
.center[
```{r, echo=FALSE, out.width=175}
knitr::include_graphics("yihui.png")
```
]
]
...
.pull-left[
```{r, echo=FALSE, out.width=175}
knitr::include_graphics("r4ds.jpg")
```
...
.pull-right[
```{r, echo=FALSE, out.width=175}
knitr::include_graphics("healy.jpg")
```
...
knitr::include_graphics("bsbr.jpg")
```
]
...
knitr::include_graphics("github.svg")
```
